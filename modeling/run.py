...
from transformers import (CONFIG_MAPPING, MODEL_FOR_MASKED_LM_MAPPING,
                          ...
                          Trainer, TrainingArguments, XLMRobertaTokenizer,
...
class ModelArguments:
    ...
    spm_name: Optional[str] = field(
        default=None, metadata={"help": "Custom tokenizer name or path if not the same as model_name"}
    )
