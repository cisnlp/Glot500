...
| Yes | [CCNet](https://github.com/facebookresearch/cc_net) | [Link](https://aclanthology.org/2020.lrec-1.494/) |  | | |
| Yes | [Clarin](http://www.clarin.si/info/about/) (subset) | |  | | | CC-BY 4.0 | 
...
| Partially | [MTData](https://github.com/thammegowda/mtdata) | [Link](https://aclanthology.org/2021.acl-demo.37/) | Multiple languages | Various sources |  | Multiple licenses **(TODO: link to spreadsheet)**
...
| Partially | [OPUS](https://opus.nlpl.eu/) | [Link](https://aclanthology.org/L12-1246/) | | Collection of translated texts from the web | Automatically collected |  Multiple licenses | 
...
| Partially | [StatMT](https://statmt.org/) | | |  | | Multiple licenses **(TODO: link to spreadsheet)** | 
